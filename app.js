...
(function () {
  ...
  // Arcade chrome so it sits under the Dunkwise topbar + footer like the other native games.
  // Same-origin and ad-free (the page sets data-embed); framing keeps the game's full-app
  // stylesheet isolated from the site shell rather than colliding with it.
